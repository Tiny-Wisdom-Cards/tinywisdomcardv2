...
const FAQ_SCHEMA = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The A–Z Ancient Wisdom deck costs Rs 499 and ships in 2–4 days. The Ka–Kha Sanskaar Lipi deck is available for preorder at Rs 349 (retail price at launch will be Rs 499) and ships in August 2026. Buying both decks together as the Tiny Wisdom Bundle costs Rs 829, saving Rs 19 compared with buying separately."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Tiny Wisdom Cards offers shipping all across Nepal. International shipping is available — contact tinywisdomcards@gmail.com or call +977 9705812366 for a shipping quote."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The Tiny Wisdom Bundle includes both the A–Z Ancient Wisdom deck and the Ka–Kha Sanskaar Lipi deck — 63 cards in total, plus both guide books — packed in a single gift-ready sleeve. It costs Rs 829, saving Rs 19 compared to buying the decks separately. The A–Z portion ships immediately; the Ka–Kha portion ships in August 2026."
      }
    }
  ]
};
    ...
    >
      ...
      >
        ...
        <AeoSection title="The Two Decks">
          ...
          <FactTable rows={[
            ['Preorder price', 'Rs 349'],
            ['Retail price at launch', 'Rs 499'],
          ...
          <FactTable rows={[
            ['Bundle price', 'Rs 829'],
            ['Individual price', 'Rs 848 (Rs 499 + Rs 349)'],
            ['Saving', 'Rs 19'],
        ...
        <AeoSection title="Frequently Asked Questions">
          ...
          <QA q="How much do Tiny Wisdom Cards cost?">
            The A–Z Ancient Wisdom deck costs <strong>Rs 499</strong> and ships in 2–4 days. The Ka–Kha Sanskaar Lipi deck is available for preorder at <strong>Rs 349</strong> (retail price at launch: Rs 499) and ships in August 2026. Buying both decks as the Tiny Wisdom Bundle costs <strong>Rs 829</strong> — saving Rs 19.
          </QA>
          ...
          <QA q="Do you ship internationally?">
            Yes. Shipping all across Nepal is available. International shipping is available — contact <strong>tinywisdomcards@gmail.com</strong> or call <strong>+977 9705812366</strong> for a quote.
          </QA>
        ...
        <AeoSection title="Quick Reference — All Products">
          <FactTable rows={[
            ...
            ['Ka–Kha Sanskaar Lipi Deck (32 cards + guide)', 'Rs 349 preorder · ships August 2026'],
            ['Tiny Wisdom Bundle (both decks, 63 cards)', 'Rs 829 · Rs 19 off vs separate'],
...
function CanonicalMeta() {
  React.useEffect(() => {
    ...
    const desc = Object.assign(document.createElement('meta'), {
      name: 'description',
      content: 'Tiny Wisdom Cards makes bilingual English & Nepali alphabet learning card decks for children aged 3+. Two decks: A–Z Ancient Wisdom (Rs 499) and Ka–Kha Sanskaar Lipi (Rs 349 preorder). Made in Kathmandu.',
    });
