      ...
      <div style={{ padding: "72px 64px 0", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center", height: "calc(100% - 90px)" }}>
        ...
        <div style={{ position: "relative", height: "100%", display: "flex", alignItems: "center" }}>
          <div style={{
            ...
            <img src="/assets/kakha-cover.png" alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
          </div>
          <div style={{
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.1fr 0.9fr", height: "calc(100% - 110px)" }}>
        ...
        <div style={{ position: "relative", overflow: "hidden", display: "grid", gridTemplateRows: "1fr 1fr 1fr" }}>
          <div style={{ background: "#2D6E60", position: "relative" }}>
            ...
            <img src="/assets/Ka-Kha-Front Ka.png" alt="" style={{ position: "absolute", top: 30, left: 60, width: 160, transform: "rotate(-8deg)", borderRadius: 8, boxShadow: "0 16px 30px rgba(0,0,0,0.3)" }} />
            <span style={{
          ...
          <div style={{ background: "#4A1E66", position: "relative" }}>
            ...
            <img src="/assets/kakha-cover.png" alt="" style={{ position: "absolute", top: 10, right: 60, width: 180, transform: "rotate(5deg)", borderRadius: 8, boxShadow: "0 16px 30px rgba(0,0,0,0.3)" }} />
            <span style={{
          ...
          <div style={{ background: "#C9962A", position: "relative" }}>
            ...
            <img src="/assets/Ka-Kha-Front a aa.png" alt="" style={{ position: "absolute", bottom: 30, left: 80, width: 160, transform: "rotate(7deg)", borderRadius: 8, boxShadow: "0 16px 30px rgba(0,0,0,0.3)" }} />
            <span style={{
      ...
      <div style={{
        ...
        <div style={{ position: "relative", height: "100%" }}>
          <div style={{
            ...
            <img src="/assets/kakha-cover.png" alt="" style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: 14 }} />
          </div>
          <div style={{
            ...
            <img src="/assets/Ka-Kha-Front a aa.png" alt="" style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: 14 }} />
          </div>
          {/* Star sticker */}
          <div style={{
